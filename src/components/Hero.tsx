...
const Hero = () => {
  return (
    <div id='home' className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative">
        <div className="flex flex-col items-center justify-center min-h-screen max-w-4xl mx-auto text-center">
          ...
          Dando forma a las soluciones del mañana con ingeniería innovadora y tecnología punta.
          </p>
